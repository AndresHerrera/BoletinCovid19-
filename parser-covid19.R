...
for(i in 1:numero_boletines) 
{
  ...
  boletinHTML <-  paste(boletinHTML,"Según el instituto nacional de salud, esta es la situación a la fecha:<br><br>","<center><b>Situación Epidemiológica del COVID-19</b><br>" , fechaSituacionInicial[i]," a ", fechaSituacionFinal[i],"</center>", sep="")
  ...
  <tr>
    ...
    <th class='verde' >% Recuperación</th>
